...
d_itemlbl <- read_csv(str_c(mimic_path, "/icu/d_items.csv.gz")) %>%
  print(width = Inf)
#from his data set I dont get anything with spo2 data, I only get 7 unique variables and it seems like there should be 8 but its not pulling the 8th.
d_itemlbl[d_itemlbl$itemid == 223761,]
d_items <- c("heart rate", "Arterial Blood Pressure systolic", "Arterial Blood Pressure mean", "Non Invasive Blood Pressure systolic", "Non Invasive Blood Pressure mean", "Temperature Fahrenheit", "Respiratory rate")
