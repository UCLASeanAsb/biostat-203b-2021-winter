...
![](Hw2/PhysioNet-Credentialed.PNG)
...
ggplot(data = dfadd,mapping = aes(x = mday(admittime) , y = stat(count),axis(1, seq(1,30,1))))+ geom_freqpoly(stat = "count") + scale_x_continuous(n.breaks = 30) 
